...
{
    public class GetYearlyRegisterChartViewComponent : ViewComponent
    {
        private readonly IAdminDashboardService _adminDashboardService;

        public GetYearlyRegisterChartViewComponent(IAdminDashboardService adminDashboardService)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var apiData = await _adminDashboardService.GetYearlyRegisterChart(token);
