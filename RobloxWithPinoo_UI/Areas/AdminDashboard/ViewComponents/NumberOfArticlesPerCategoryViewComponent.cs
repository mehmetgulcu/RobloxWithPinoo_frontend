...
{
    public class NumberOfArticlesPerCategoryViewComponent : ViewComponent
    {
        private readonly IAdminDashboardService _adminDashboardService;

        public NumberOfArticlesPerCategoryViewComponent(IAdminDashboardService adminDashboardService)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var apiData = await _adminDashboardService.GetNumberOfArticlesPerCategory(token);
