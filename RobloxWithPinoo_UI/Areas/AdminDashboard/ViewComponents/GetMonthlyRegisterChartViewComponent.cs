...
{
    public class GetMonthlyRegisterChartViewComponent : ViewComponent
    {
        private readonly IAdminDashboardService _adminDashboardService;

        public GetMonthlyRegisterChartViewComponent(IAdminDashboardService adminDashboardService)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var apiData = await _adminDashboardService.GetMonthlyRegisterChart(token);
