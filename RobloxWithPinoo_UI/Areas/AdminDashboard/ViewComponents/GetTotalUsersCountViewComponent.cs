...
{
    public class GetTotalUsersCountViewComponent : ViewComponent
    {
        private readonly IAdminDashboardService _adminDashboardService;

        public GetTotalUsersCountViewComponent(IAdminDashboardService adminDashboardService)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var count = await _adminDashboardService.GetTotalUsersCount(token);
